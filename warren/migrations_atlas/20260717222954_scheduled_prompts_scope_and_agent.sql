...
ALTER TABLE "public"."scheduled_prompts" ALTER COLUMN "target_class" DROP NOT NULL, ADD COLUMN "scope" character varying NOT NULL, ADD COLUMN "agent_id" uuid NULL, ADD COLUMN "ignore_pending_forgejo_work" boolean NOT NULL, ADD CONSTRAINT "fk-scheduled_prompts-agent_id" FOREIGN KEY ("agent_id") REFERENCES "public"."agents" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;
